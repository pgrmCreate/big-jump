...
exports.reconnect = (req, res, next) => {
    ...
    try {
        const decodedToken = jwt.verify(targetCookieUser.token, 'Dz99z5a9q6d5z9464fes98fd4sefse6ef9se465fDDRAMD_4dqz');
...
exports.signup = (req, res, next) => {
    bcrypt.hash(req.body.password, 10)
        .then((hash) => {
            ...
            newUser.save()
                .then((addedUser) => res.status(201).json({ message : 'new user added : ' + addedUser.id }))
        })
